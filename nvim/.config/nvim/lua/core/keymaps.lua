...
vim.keymap.set('n', '[d', function()
  vim.diagnostic.jump { count = -1, float = true, { desc = 'Go to previous diagnostic message' } }
end)
vim.keymap.set('n', ']d', function()
  vim.diagnostic.jump { count = 1, float = true, { desc = 'Go to next diagnostic message' } }
end)
